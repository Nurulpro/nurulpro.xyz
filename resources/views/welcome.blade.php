...
<head>
  ...
  * Template URL: https://bootstrapmade.com/Nurulpro-free-skin-bootstrap-3/
        ...
        <div class="container-fluid" data-aos="fade-up">
            <div class="row justify-content-center">
                <div class="col-xl-5 col-lg-6 pt-3 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    <h1>Bettter Digital Experience With Nurulpro</h1>
                    <h2>We are team of talented designers making websites with PHP with Laravel Framework and Using Frontend React Library</h2>
                ...
                <div class="row gy-4">
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                        <div class="icon-box iconbox-blue">
                            ...
                            <p>We provide a full range of web application services, from requirement gathering until the application is successfully deployed on the client end.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="200">
                        <div class="icon-box iconbox-orange ">
                            ...
                            <p>Well-built software thinks about users and their needs. Web Sites require one thing, and that is functionality. Without it most websites are useless.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="300">
                        <div class="icon-box iconbox-pink">
                            ...
                            <p>We provide unique mobile application development services to develop solutions that solve real-life problems.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="200">
                        <div class="icon-box iconbox-red">
                            ...
                            <h4><a href="">Customized ERP</a></h4>
                            <p></p> ERP Solution is a suite of applications that manages core business process such as sales, purchasing, human resources, customer support,</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="300">
                        <div class="icon-box iconbox-teal">
                            ...
                            <h4><a href="">Customized E-commerce</a></h4>
                            <p>We also Customized any E-commerce website or integration any feature</p>
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="copyright-wrap d-md-flex py-4">
                <div class="me-md-auto text-center text-md-start">
                    <div class="copyright">
                        &copy; Copyright <strong><span>Nurulpro</span></strong>. All Rights Reserved
                    </div>
                    <div class="credits">
                        <!-- All the links in the footer should remain intact. -->
                        <!-- You can delete the links only if you purchased the pro version. -->
                        <!-- Licensing information: https://bootstrapmade.com/license/ -->
                        <!-- Purchase the pro version with working PHP/AJAX contact form: https://bootstrapmade.com/Nurulpro-free-skin-bootstrap-3/ -->
                        Designed by <a href="http://nurulpro.xyz/">Nurul Islam</a>
                    </div>
                </div>
                <div class="social-links text-center text-md-right pt-3 pt-md-0">
                    <a href="https://twitter.com/NurulIs79176036" class="twitter"><i class="bx bxl-twitter"></i></a>
                    <a href="https://www.facebook.com/nurulni24" class="facebook"><i class="bx bxl-facebook"></i></a>
                    <a href="https://www.instagram.com/nurulpro24/" class="instagram"><i class="bx bxl-instagram"></i></a>

                    <a href="https://www.linkedin.com/in/nurul-islam-30071a1ba/" class="linkedin"><i class="bx bxl-linkedin"></i></a>
                </div>
            </div>
